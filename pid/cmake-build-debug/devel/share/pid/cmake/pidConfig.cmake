...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/shaffei/embedded/src/pid)
  set(pid_DEVEL_PREFIX /home/shaffei/embedded/src/pid/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'shaffei <shaffei@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shaffei/embedded/src/pid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shaffei/embedded/src/pid/cmake-build-debug/devel/lib;/home/shaffei/embedded/devel/lib;/opt/ros/melodic/lib)
